...
export default function Hero({ model, canEdit }) {
  ...
  return (
    <section className="hero wrap">
      <motion.div variants={STAGGER} initial="hidden" animate="show">
        <motion.div variants={ITEM} className="hero-eyebrow eyebrow">Executive ESG Monitoring — PELH 2026 · KPP PELH</motion.div>
        ...
        <motion.div variants={ITEM} style={{ marginTop: 40 }}>
          <MediaSlot id="hero" label="Foto / video utama site PELH" tag="PELH · SITE" aspect="21 / 9" editable={canEdit} />
        </motion.div>
      </motion.div>
    </section>
  );
